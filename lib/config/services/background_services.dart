    ...
    if (service is AndroidServiceInstance) {
      if (await service.isForegroundService()) {
        ...
        if (x == "CONECTADO") {
          ...
          final token =
              await LocalStorageServices.getLocalData(KeyTypes.userToken);
          if (token != null) {
            if (token.isNotEmpty) {
              try {
                Position position = await Geolocator.getCurrentPosition(
                    desiredAccuracy: LocationAccuracy.high);
                apiServices.updatePosition(token, position.latitude.toString(),
                ...
                service.setForegroundNotificationInfo(
                  title: "ERROR AL ACTUALIZAR LA UBICACION",
                  content: "Hubo un error al actualizar la ubicacion ",
                );
              }
            }
          }
          ...
          service.setForegroundNotificationInfo(
            title: "No conectado",
            content: "No hay coneccion a internet",
          );
        }
      }
    }
